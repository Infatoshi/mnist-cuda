...
//     // Compute dW2 = x2.T @ dLoss = (256, B) @ (B, 10) = (256, 10)
//     cublasSgemm(handle, CUBLAS_OP_N, CUBLAS_OP_T, output_size, hidden_size, batch_size,
//                 &alpha, d_grad_output, output_size, d_hidden, hidden_size,
//                 &beta, d_grad_weights2, output_size);
...
//     // Compute dW1 = x1.T @ dRelu = (784, B) @ (B, 256) = (784, 256)
//     cublasSgemm(handle, CUBLAS_OP_N, CUBLAS_OP_T, hidden_size, input_size, batch_size,
//                 &alpha, d_grad_hidden, hidden_size, d_input, input_size,
//                 &beta, d_grad_weights1, hidden_size);
